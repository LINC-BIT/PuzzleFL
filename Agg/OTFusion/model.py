...
import Agg.OTFusion.cifar.train as cifar_train

def get_model_from_name(args, idx=-1,output=100):
    ...
    if args.model_name == 'net':
    ...
    elif args.model_name[0:3] == 'vgg' or args.model_name[0:3] == 'res'  or args.model_name == 'sixcnn' or args.model_name == 'textcnn' or args.model_name == 'GCN':
        ...
        return cifar_train.get_model(barebone_config, args.server_gpu, relu_inplace=not args.prelu_acts,output=output)
