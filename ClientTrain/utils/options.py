...
def args_parser():
    ...
    # federated arguments
    parser.add_argument('--epochs', type=int, default=100, help="rounds of training")                                       # 总的 round 数
    parser.add_argument('--clmethod', type=str, default='GEM',required=False, help="method of continual learning")
    parser.add_argument('--num_users', type=int, default=10, help="number of users: n")
    parser.add_argument('--shard_per_user', type=int, default=8, help="classes per user")
    parser.add_argument('--frac', type=float, default=1, help="the fraction of clients: C")
    parser.add_argument('--local_ep', type=int, default=10, help="the number  of local epochs: E")                          # 本地训练 epochs 数
    parser.add_argument('--local_test_bs', type=int, default=50, help="the number  of local test epochs: E")
    parser.add_argument('--local_bs', type=int, default=40, help="local batch size: B")                                     # batch size
    ...
    parser.add_argument('--m_ft', type=int, default=240, help="maximum number of samples/user to use for fine-tuning")      # 样本数截断
    parser.add_argument('--neibour', type=int, default=2, help="maximum number of samples/user to use for fine-tuning")     # 客户端数量
    ...
    parser.add_argument('--round', type=int, default=6, help='train number of the per-task')    # 每个任务的Round数
    parser.add_argument('--task', type=int, default=10, help='train number of task')            # 任务个数
