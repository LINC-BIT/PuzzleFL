...
from FCL.FedViT.RepAGG import FedRepAVG
from Agg.FedAvg import FedAvg

from FCL.FedViT.FedViTRep import Appr, LongLifeTrain
...
if __name__ == '__main__':
    ...
    data_shape = (3, 32, 32)    
    apprs = [Appr(copy.deepcopy(net_glob).to(args.device), data_shape, n_outputs=200, n_tasks=20, args=args) for i in range(args.num_users)]
    ...
    for iter in range(args.epochs):
        ...
        for ind, idx in enumerate(idxs_users):
            ...
            local_w, _, loss = LongLifeTrain(args, appr, iter, idx)
