...
- [GCN](https://arxiv.org/abs/1609.02907): Graph Convolutional Network (GCN) is a deep learning framework designed to process graph-structured data by iteratively aggregating features from neighboring nodes to learn meaningful node representations for tasks like node classification or link prediction.
