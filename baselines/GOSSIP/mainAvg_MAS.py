...
from ClientTrainAvg.LongLifeMethod.Avg_MAS import Appr,LongLifeTest,LongLifeTrain
...
if __name__ == '__main__':
    ...
    print(args.alg)
    write = SummaryWriter('/data/lpyx/FedAgg/ClientTrainAvg/log/MAS/MAS_high20_dag_' + args.dataset+'_'+'round' + str(args.round) + '_frac' + str(args.frac))
    # build model
