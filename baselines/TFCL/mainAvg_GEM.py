...
from ClientTrainAvg.LongLifeMethod.Avg_GEM import Appr,LongLifeTrain
...
if __name__ == '__main__':
    ...
    print(args.alg)
    write = SummaryWriter('/data/lpyx/FedAgg/ClientTrainAvg/log/GEM/GEM_high_20past_cd ' + args.dataset+'_'+'round' + str(args.round) + '_frac' + str(args.frac))
    # build model
